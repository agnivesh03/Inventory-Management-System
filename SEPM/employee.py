...
class employeeClass:
    def __init__(self,root):
        ...
        cmb_search.place(x=10, y=10, width=189)
        cmb_search.current(0)

        txt_search=Entry (SearchFrame,textvariable=self.var_searchtxt, font=("goudy old style", 15), bg="lightyellow").place(x=200,y=10)
        btn_search=Button(SearchFrame,text='Search',command=self.search, font=("goudy old style", 15), bg="#4caf50",fg='black',cursor='hand2').place(x=410,y=9,width=150,height=30)
        ...
        lbl_gender=Label(self.root,text="Gender",font=("goudy old style", 15),bg="white",fg='black').place (x=350, y=150)
        ...
        # txt_gender=Entry(self.root,textvariable=self.var_gender,font=("goudy old style", 15),bg="white",fg='black').place(x=500,y=150, width=180)
        ...
        lbl_dob=Label(self.root,text="D.O.B",font=("goudy old style", 15),bg="white",fg='black').place (x=350, y=190)
        ...
        lbl_usertype=Label(self.root,text="Usertype",font=("goudy old style", 15),bg="white",fg='black').place (x=750, y=230)
        ...
        txt_password=Entry(self.root,textvariable=self.var_pass,font=("goudy old style", 15),bg="lightyellow",fg='black').place(x=500,y=230, width=180)
        # txt_utype=Entry(self.root,textvariable=self.var_utype,font=("goudy old style", 15),bg="lightyellow",fg='black').place(x=850,y=230, width=180)
        ...
        # ===========row4==========
        lbl_address=Label(self.root,text="Address",font=("goudy old style", 15),bg="white",fg='black').place (x=50, y=270)
        lbl_salary=Label(self.root,text="Salary",font=("goudy old style", 15),bg="white",fg='black').place (x=500, y=270)

        self.txt_address=Text(self.root,font=("goudy old style", 15),bg="lightyellow",fg='black')
        self.txt_address.place(x=150,y=270, width=300,height=60)
        txt_salary=Entry(self.root,textvariable=self.var_salary,font=("goudy old style", 15),bg="lightyellow",fg='black').place(x=600,y=270, width=180)

        # =============buttons===========
        btn_add=Button(self.root,text='Save',command=self.add,font=("goudy old style", 15), bg="#2196f3",fg='black',cursor="hand2").place(x=500, y=305 , width=110, height=28)
        ...
        self.EmployeeTable.heading("address", text="Addres")
