...
# ==============images=========================
        ...
        or_=Label(login_frame,text="OR",font=('times new roman',15,'bold'),bg="white").place(x=155, y=357)

        btn_forget=Button(login_frame,command=self.forget_window, text="Forget Password",font=('times new roman', 15),bg="white",activebackground="white",fg="#00B0F0",activeforeground="#00B0F0",bd=0,cursor='hand2').place (x=100,y=390)
        ...
        lbl_reg=Label(register_frame,text="Don't Have an acount ?",font=('times new roman',15,'bold'),bg='white').place(x=40,y=15)
        btn_signup=Button(register_frame, text="Sign Up",font=("times new roman", 15,'bold'), bg="white", fg="#00759E",bd=0,activebackground='white',activeforeground="#00759E").place (x=200,y=15)
        ...
        try:
            if self.employee_id.get ()=="":
                ...
                if email==None:
                    ...
                    lbl_reset=Label(self. forget_win,text='Enter OTP sent on registered E-mail :',font=('times new roman',15)).place(x=20,y=60)
                    txt_reset=Entry(self. forget_win,textvariable=self.var_otp,font=('times new roman',15),bg='lightyellow').place(x=20,y=85,width=240,height=30)
                    ...
                    lbl_new_pass=Label(self. forget_win,text='Confirm Password :',font=('times new roman',15)).place(x=20,y=225)
                    txt_c_pass=Entry(self. forget_win,textvariable=self.var_conf_pass,font=('times new roman',15),bg='lightyellow').place(x=20,y=255,width=240,height=30)
