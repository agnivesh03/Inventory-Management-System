...
class SEPM:
    def __init__(self,root):
        ...
        # ======footer=====
        lbl_footer=Label(self.root,text="SIM - Smart Inventory Management\nFor any issues contanct : 98xxxxxx6x",font=("time news roman",12),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
        self.update_content()
# ================================================================================================================
    def employee(self):
