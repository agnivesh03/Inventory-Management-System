...
# ===================TITLE=======================
        lb1_title=Label(self.root, text="View Customer Bills ",font=("goudy old style", 30),bg="#184a45", fg= "white",bd=3, relief=RIDGE).pack(side=TOP , fill=X,padx=10, pady=20)
...
# ===================Bill Area=======================
        ...
        lb1_title2=Label(bill_Frame, text="Customer Bills Area",font=("goudy old style", 20),bg="orange").pack(side=TOP,fill=X)
...
#================================================
    ...
    def show(self):
        ...
        #print (os.listdir('../SEPM')) billl.txt, category.py
